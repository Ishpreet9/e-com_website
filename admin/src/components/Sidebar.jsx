...
const Sidebar = () => {
  ...
  return (
    <div className='mt-20 flex flex-col gap-10 items-end'>
      {/* add button  */}
      <NavLink className={`flex items-center justify-center gap-5 border-2 rounded-l-lg border-r-0 w-52 transition-all duration-500 ${current_route === '/' ? 'border-yellow-400 border-opacity-70 bg-yellow-400 bg-opacity-10 text-neutral-100' : 'border-neutral-200 text-neutral-200 bg-black bg-opacity-50'}`} to={'/'}>
      ...
      {/* orders button  */}
      <NavLink className={`flex items-center justify-center gap-5 border-2 rounded-l-lg border-r-0 w-52 transition-all duration-500 ${current_route === '/orders' ? 'border-yellow-400 border-opacity-70 bg-yellow-400 bg-opacity-10 text-neutral-100' : 'border-neutral-200 text-neutral-200 bg-black bg-opacity-50'}`} to={'/orders'}>
