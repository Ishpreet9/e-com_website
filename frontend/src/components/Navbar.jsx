  ...
  return (
    ...
    <div className='flex item-center justify-between py-3 font-medium'>
        ...
        <div className='flex items-center gap-6'>
            <img onClick={()=>setShowSearch(!showSearch)} src={assets.search_icon} className='w-[29px] cursor-pointer' alt="search_icon" />

            <div className='group relative'>
                <Link to='/login'><img src={assets.profile_icon} className='w-[21px] cursor-pointer' alt="profile_icon" /></Link>
            ...
            <NavLink to='/cart' className='relative'>
                ...
                <p className='absolute right-[-5px] bottom-[14px] w-4 text-center leading-4 bg-black text-white aspect-square rounded-full text-[9px]'>{getCartCount()}</p>
            </NavLink>
